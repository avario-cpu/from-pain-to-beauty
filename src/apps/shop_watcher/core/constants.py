...
SHOP_TEMPLATE_IMAGE_PATH = os.path.join(
    PROJECT_DIR_PATH, "src/apps/shop_watcher/data/opencv/shop_top_right_icon.jpg"
)

# ws requests
BRB_BUYING_MILK_SHOW = os.path.join(
    PROJECT_DIR_PATH, "src/apps/shop_watcher/data/ws_requests/brb_buying_milk_show.json"
)
BRB_BUYING_MILK_HIDE = os.path.join(
    PROJECT_DIR_PATH, "src/apps/shop_watcher/data/ws_requests/brb_buying_milk_hide.json"
)
DSLR_HIDE = os.path.join(
    PROJECT_DIR_PATH, "src/apps/shop_watcher/data/ws_requests/dslr_hide.json"
)
DSLR_SHOW = os.path.join(
    PROJECT_DIR_PATH, "src/apps/shop_watcher/data/ws_requests/dslr_show.json"
)
...
TIME_SINCE_SHOP_OPENED_TXT = os.path.join(
    PROJECT_DIR_PATH, "src/apps/shop_watcher/data/time_since_shop_opened.txt"
)
